...
class Login_test(unittest.TestCase):
    ...
    def test_04_first_splash_screen(self):
        self.setUpClass()
        ...
        print("test 04 : Splash screen passed")
        self.driver.close_app()
        time.sleep(3)

    def test_05_landing_on_registration_page(self):
        self.setUpClass()
        time.sleep(5)
        ...
        print("test 05 : landing on registration page passed.")
        self.driver.close_app()
        time.sleep(2)

    def test_06_landing_on_TFA_screen(self):
        self.setUpClass()
        time.sleep(5)
        self.driver.find_element(by=By.ID, value="com.bitjeem.android:id/loginBtn_landing").click()
        time.sleep(4)
    ...
    def test_07_landing_on_bitjeem_landing_page(self):
        self.setUpClass()
        time.sleep(5)
        activity = self.driver.current_activity
        print(activity)
        ...
        print("test 07: landing on bitjeem mobile landing page passed")
        self.driver.close_app()
        time.sleep(3)

    def test_08_landing_on_login_page(self):
        self.setUpClass()
        time.sleep(5)
        self.driver.find_element(by=By.ID, value="com.bitjeem.android:id/loginBtn_landing").click()
        time.sleep(4)
        ...
        print("test 08 : landing on login page passed.")
        self.driver.close_app()
        time.sleep(2)
